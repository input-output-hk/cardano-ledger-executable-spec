                   ...
                   (\ v3 ->
                      coe
                        ...
                        (coe
                           ...
                           (coe
                              MAlonzo.Code.Interface.MonadReader.du_reader_78 (coe ())
                              (coe MAlonzo.Code.Reflection.TCI.d_Monad'45'TC_18)
                              (coe MAlonzo.Code.Meta.d_iMonadReader'45'TC_6) (coe ())
                              (coe (\ v4 -> MAlonzo.Code.Interface.MonadTC.d_goal_52 (coe v4))))
                           (coe du_'46'extendedlambda0_30 (coe v2) (coe v1)) v3))))
