  ...
  = coe
      ...
      (\ v5 ->
         coe
           ...
           (coe
              du_adjustParams_22 (coe v0) (coe v1)
              (coe
                    ...
                    coe
                      ...
                      (\ v10 ->
                         coe
                           ...
                           MAlonzo.Code.Meta.d_iMonad'45'TC_2 () erased () erased
                           (coe
                              MAlonzo.Code.Interface.MonadReader.d_local_72
                              MAlonzo.Code.Meta.d_iMonadReader'45'TC_6 () erased
                              (\ v11 ->
                                 coe
                                   MAlonzo.Code.Interface.MonadTC.C_TCEnv'46'constructor_953
                                   (coe MAlonzo.Code.Interface.MonadTC.d_normalisation_40 (coe v11))
                                   (coe
                                      MAlonzo.Code.Interface.MonadTC.d_reconstruction_42 (coe v11))
                                   (coe MAlonzo.Code.Interface.MonadTC.d_noConstraints_44 (coe v11))
                                   (coe MAlonzo.Code.Interface.MonadTC.d_reduction_46 (coe v11))
                                   (coe MAlonzo.Code.Interface.MonadTC.d_globalContext_48 (coe v11))
                                   (coe MAlonzo.Code.Interface.MonadTC.d_localContext_50 (coe v11))
                                   (coe MAlonzo.Code.Data.Sum.Base.C_inj'8322'_42 (coe v9))
                                   (coe MAlonzo.Code.Interface.MonadTC.d_debug_54 (coe v11)))
                              (coe
