...
d_'8801''45'just'8660'STS_108 ~v0 ~v1 ~v2 ~v3 v4 v5 v6 v7 v8
  = du_'8801''45'just'8660'STS_108 v4 v5 v6 v7 v8
du_'8801''45'just'8660'STS_108 ::
  ...
  AgdaAny ->
  AgdaAny -> MAlonzo.Code.Function.Bundles.T_Equivalence_1714
du_'8801''45'just'8660'STS_108 v0 v1 v2 v3 v4
  = let v5 = coe d_computeProof_88 v0 v1 v2 v3 in
    coe
      (case coe v5 of
                          ...
                          (\ v9 ->
                             coe
                               ...
                               (coe
                                  ...
                                  erased (coe MAlonzo.Code.Agda.Builtin.Maybe.C_just_16 (coe v7))
                                  (coe du_compute_90 (coe v0) (coe v1) (coe v2) (coe v3))
                                  (coe MAlonzo.Code.Agda.Builtin.Maybe.C_just_16 (coe v4))
                                  (coe
                                     MAlonzo.Code.Relation.Binary.Reasoning.Syntax.du_step'45''8801''45''10217'_436
                                     erased (coe du_compute_90 (coe v0) (coe v1) (coe v2) (coe v3))
                                     (coe MAlonzo.Code.Agda.Builtin.Maybe.C_just_16 (coe v4))
                                     (coe MAlonzo.Code.Agda.Builtin.Maybe.C_just_16 (coe v4))
                                     (coe
                ...
                (coe
                   (\ v6 ->
                      coe
                        ...
                        (coe
                           MAlonzo.Code.Relation.Binary.Reasoning.Syntax.du_step'45''8801''728'_452
                           erased v5 (coe du_compute_90 (coe v0) (coe v1) (coe v2) (coe v3))
                           (coe MAlonzo.Code.Agda.Builtin.Maybe.C_just_16 (coe v4))
                           (coe
                              MAlonzo.Code.Relation.Binary.Reasoning.Syntax.du_step'45''8801''45''10217'_436
                              erased (coe du_compute_90 (coe v0) (coe v1) (coe v2) (coe v3))
...
du_'8801''45'just'8660'STS_204 ::
  ...
  AgdaAny ->
  AgdaAny -> MAlonzo.Code.Function.Bundles.T_Equivalence_1714
du_'8801''45'just'8660'STS_204 v0
  = coe du_'8801''45'just'8660'STS_108 (coe v0)
...
du_'8801''45'just'8660'STS_378 ::
  ...
  AgdaAny ->
  AgdaAny -> MAlonzo.Code.Function.Bundles.T_Equivalence_1714
du_'8801''45'just'8660'STS_378 v0
  = coe du_'8801''45'just'8660'STS_108 (coe v0)
-- Interface.ComputationalRelation._._.completeness
d_completeness_382 ::
  T_Computational_50 ->
...
du_'8801''45'just'8660'STS_392 ::
  ...
  AgdaAny ->
  AgdaAny -> MAlonzo.Code.Function.Bundles.T_Equivalence_1714
du_'8801''45'just'8660'STS_392 v0
  = coe du_'8801''45'just'8660'STS_108 (coe v0)
...
d_Computational'45'ReflexiveTransitiveClosure'7495'_450 ::
  () ->
  () ->
  (AgdaAny ->
   AgdaAny ->
...
d_Computational'45'ReflexiveTransitiveClosure'7495'_450 ~v0 ~v1 ~v2
                                                        v3 ~v4 ~v5 v6
  = du_Computational'45'ReflexiveTransitiveClosure'7495'_450 v3 v6
du_Computational'45'ReflexiveTransitiveClosure'7495'_450 ::
  T_Computational_50 -> T_Computational_50 -> T_Computational_50
du_Computational'45'ReflexiveTransitiveClosure'7495'_450 v0 v1
  = coe
      C_MkComputational_176
      (\ v2 v3 v4 ->
         case coe v4 of
      ...
      MAlonzo.Code.Agda.Builtin.Sigma.C__'44'__32 v5 v6
        -> coe
             ...
             (coe
                d_computeProof_88
                (coe
                   du_Computational'45'ReflexiveTransitiveClosure'7495'_450 (coe v0)
                   (coe v1))
                v2 v5 v3)
             (coe
                (\ v7 ->
                     ...
                     MAlonzo.Code.Agda.Builtin.Sigma.C__'44'__32 v8 v9
                       -> coe
                            ...
                            (coe
                               ...
                               (coe MAlonzo.Code.Interface.STS.C_BS'45'ind_70 v5 v6 v9))
                     _ -> MAlonzo.RTE.mazUnreachableError))
      _ -> MAlonzo.RTE.mazUnreachableError
-- Interface.ComputationalRelation._._.Computational-ReflexiveTransitiveClosureᵢᵇ
d_Computational'45'ReflexiveTransitiveClosure'7522''7495'_572 ::
  () ->
  () ->
  (AgdaAny ->
   AgdaAny ->
  ...
  T_Computational_50 -> T_Computational_50
d_Computational'45'ReflexiveTransitiveClosure'7522''7495'_572 ~v0
                                                              ~v1 ~v2 v3 ~v4 ~v5 v6
  = du_Computational'45'ReflexiveTransitiveClosure'7522''7495'_572
      v3 v6
du_Computational'45'ReflexiveTransitiveClosure'7522''7495'_572 ::
  T_Computational_50 -> T_Computational_50 -> T_Computational_50
du_Computational'45'ReflexiveTransitiveClosure'7522''7495'_572 v0
                                                               v1
  = coe
      C_MkComputational_176
      (\ v2 v3 v4 ->
                   ...
                   case coe v7 of
                     MAlonzo.Code.Agda.Builtin.Sigma.C__'44'__32 v8 v9
                       -> coe
                            ...
                            (coe
                               MAlonzo.Code.Agda.Builtin.Sigma.C__'44'__32 (coe v8)
                               (coe MAlonzo.Code.Interface.STS.C_BS'45'ind_90 v5 v6 v9))
                     _ -> MAlonzo.RTE.mazUnreachableError))
      _ -> MAlonzo.RTE.mazUnreachableError
-- Interface.ComputationalRelation.Computational-ReflexiveTransitiveClosure
d_Computational'45'ReflexiveTransitiveClosure_686 ::
  () ->
  () ->
  () ->
  (AgdaAny -> AgdaAny -> AgdaAny -> AgdaAny -> ()) ->
  T_Computational_50 -> T_Computational_50
d_Computational'45'ReflexiveTransitiveClosure_686 ~v0 ~v1 ~v2 ~v3
                                                  v4
  = du_Computational'45'ReflexiveTransitiveClosure_686 v4
du_Computational'45'ReflexiveTransitiveClosure_686 ::
  T_Computational_50 -> T_Computational_50
du_Computational'45'ReflexiveTransitiveClosure_686 v0
  = coe
      du_Computational'45'ReflexiveTransitiveClosure'7495'_450
      (coe du_Computational'45'Id_424) (coe v0)
-- Interface.ComputationalRelation.Computational-ReflexiveTransitiveClosureᵢ
d_Computational'45'ReflexiveTransitiveClosure'7522'_690 ::
  () ->
  () ->
  () ->
  (MAlonzo.Code.Agda.Builtin.Sigma.T_Σ_14 ->
   AgdaAny -> AgdaAny -> AgdaAny -> ()) ->
  T_Computational_50 -> T_Computational_50
d_Computational'45'ReflexiveTransitiveClosure'7522'_690 ~v0 ~v1 ~v2
                                                        ~v3 v4
  = du_Computational'45'ReflexiveTransitiveClosure'7522'_690 v4
du_Computational'45'ReflexiveTransitiveClosure'7522'_690 ::
  T_Computational_50 -> T_Computational_50
du_Computational'45'ReflexiveTransitiveClosure'7522'_690 v0
  = coe
      du_Computational'45'ReflexiveTransitiveClosure'7522''7495'_572
      (coe du_Computational'45'Id_424) (coe v0)
