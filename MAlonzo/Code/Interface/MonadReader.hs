...
data T_MonadReader_50
  = C_MonadReader'46'constructor_601 AgdaAny
                                     (MAlonzo.Code.Agda.Primitive.T_Level_18 ->
                                      () -> (AgdaAny -> AgdaAny) -> AgdaAny -> AgdaAny)
...
d_ask_66 v0
  = case coe v0 of
      C_MonadReader'46'constructor_601 v1 v2 -> coe v1
...
d_local_72 v0
  = case coe v0 of
      C_MonadReader'46'constructor_601 v1 v2 -> coe v2
      _ -> MAlonzo.RTE.mazUnreachableError
...
du_MonadReader'45'ReaderT_132 v0
  = coe
      C_MonadReader'46'constructor_601
...
du_MonadError'45'ReaderT_144 v0
  = coe
      MAlonzo.Code.Interface.MonadError.C_MonadError'46'constructor_645
      (coe
         (\ v1 v2 v3 v4 ->
