...
d_Monad'45'TC_12
  = coe
      MAlonzo.Code.Interface.Monad.C_Monad'46'constructor_275
...
d_TCEnv_22 = ()
data T_TCEnv_22
  = C_TCEnv'46'constructor_953 Bool Bool Bool T_ReductionOptions_14
...
d_globalContext_48 v0
  = case coe v0 of
      C_TCEnv'46'constructor_953 v1 v2 v3 v4 v5 v6 v7 v8 -> coe v5
      _ -> MAlonzo.RTE.mazUnreachableError
-- Interface.MonadTC.TCEnv.localContext
d_localContext_50 ::
  T_TCEnv_22 -> [MAlonzo.Code.Agda.Builtin.Reflection.T_Abs_112]
d_localContext_50 v0
  = case coe v0 of
      C_TCEnv'46'constructor_953 v1 v2 v3 v4 v5 v6 v7 v8 -> coe v6
      _ -> MAlonzo.RTE.mazUnreachableError
-- Interface.MonadTC.TCEnv.goal
d_goal_52 :: T_TCEnv_22 -> MAlonzo.Code.Data.Sum.Base.T__'8846'__30
d_goal_52 v0
  = case coe v0 of
      C_TCEnv'46'constructor_953 v1 v2 v3 v4 v5 v6 v7 v8 -> coe v7
      _ -> MAlonzo.RTE.mazUnreachableError
...
d_debug_54 v0
  = case coe v0 of
      C_TCEnv'46'constructor_953 v1 v2 v3 v4 v5 v6 v7 v8 -> coe v8
      _ -> MAlonzo.RTE.mazUnreachableError
...
data T_MonadTC_104
  = C_MonadTC'46'constructor_6653 (MAlonzo.Code.Agda.Builtin.Reflection.T_Term_154 ->
                                   MAlonzo.Code.Agda.Builtin.Reflection.T_Term_154 -> AgdaAny)
...
d_unify_156 v0
  = case coe v0 of
      C_MonadTC'46'constructor_6653 v1 v2 v3 v4 v5 v6 v7 v8 v9 v10 v11 v12 v13 v14 v15 v16 v17 v18 v19 v20
        -> coe v1
      _ -> MAlonzo.RTE.mazUnreachableError
...
du_IsMErrorPart'45'IsErrorPart_452 v0 v1
  = coe
      C_IsMErrorPart'46'constructor_24403
      (coe
         (\ v2 ->
            coe
              MAlonzo.Code.Interface.Monad.d_return_28 v0 () erased
...
du_debugLog_500 v0 v1 v2 v3
  = coe
      ...
      (\ v4 ->
         case coe v4 of
           C_TCEnv'46'constructor_953 v5 v6 v7 v8 v9 v10 v11 v12
             -> coe
  ...
  = coe
      ...
      (\ v4 ->
         case coe v4 of
           C_TCEnv'46'constructor_953 v5 v6 v7 v8 v9 v10 v11 v12
             -> coe
                  C_TCEnv'46'constructor_953 (coe v5) (coe v6) (coe v7) (coe v8)
...
du_noConstraints_544 v0 v1
  = coe
      ...
      (\ v2 ->
         coe
           C_TCEnv'46'constructor_953 (coe d_normalisation_40 (coe v2))
...
du_extendContext_608 v0 v1 v2
  = coe
      ...
      (\ v3 ->
         case coe v3 of
           C_TCEnv'46'constructor_953 v4 v5 v6 v7 v8 v9 v10 v11
             -> coe
                  C_TCEnv'46'constructor_953 (coe v4) (coe v5) (coe v6) (coe v7)
                  (coe v8)
                  (coe
                     MAlonzo.Code.Agda.Builtin.List.C__'8759'__22
                     (coe
...
du_getContext_618 v0 v1
  = coe
      ...
      (coe
         (\ v2 ->
            case coe v2 of
              C_TCEnv'46'constructor_953 v3 v4 v5 v6 v7 v8 v9 v10
                -> coe
...
du_inContext_636 v0 v1 v2
  = coe
      ...
      (\ v3 ->
         coe
           C_TCEnv'46'constructor_953 (coe d_normalisation_40 (coe v3))
