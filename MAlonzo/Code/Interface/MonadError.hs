...
data T_MonadError_46
  = C_MonadError'46'constructor_645 (MAlonzo.Code.Agda.Primitive.T_Level_18 ->
                                     () -> AgdaAny -> AgdaAny)
                                    (MAlonzo.Code.Agda.Primitive.T_Level_18 ->
                                     () -> AgdaAny -> (AgdaAny -> AgdaAny) -> AgdaAny)
...
d_error_56 v0
  = case coe v0 of
      C_MonadError'46'constructor_645 v1 v2 -> coe v1
