...
data T_IsLeftUnique_406 = C_IsLeftUnique'46'constructor_2857
...
d__'8746''737'''__670 v0 ~v1 v2 ~v3 v4 v5
  = du__'8746''737'''__670 v0 v2 v4 v5
du__'8746''737'''__670 ::
  MAlonzo.Code.Axiom.Set.T_Theory_82 ->
  (AgdaAny -> AgdaAny) -> AgdaAny -> AgdaAny -> AgdaAny
du__'8746''737'''__670 v0 v1 v2 v3
  = coe
...
d_disjoint'45''8746''737''45''8746'_690 ::
  MAlonzo.Code.Axiom.Set.T_Theory_82 ->
  () ->
  (AgdaAny -> AgdaAny) ->
  () ->
  ...
  (AgdaAny ->
   ...
   AgdaAny -> MAlonzo.Code.Data.Irrelevant.T_Irrelevant_20) ->
  MAlonzo.Code.Agda.Builtin.Sigma.T_Σ_14
d_disjoint'45''8746''737''45''8746'_690 v0 ~v1 v2 ~v3 v4 v5 v6
  = du_disjoint'45''8746''737''45''8746'_690 v0 v2 v4 v5 v6
du_disjoint'45''8746''737''45''8746'_690 ::
  MAlonzo.Code.Axiom.Set.T_Theory_82 ->
  (AgdaAny -> AgdaAny) ->
  AgdaAny ->
  AgdaAny ->
  (AgdaAny ->
   ...
   AgdaAny -> MAlonzo.Code.Data.Irrelevant.T_Irrelevant_20) ->
  MAlonzo.Code.Agda.Builtin.Sigma.T_Σ_14
du_disjoint'45''8746''737''45''8746'_690 v0 v1 v2 v3 v4
  = coe
      MAlonzo.Code.Function.Bundles.d_from_1726
      (coe
...
du_insert_698 v0 v1 v2 v3 v4
  = coe
      du__'8746''737'__676 (coe v0) (coe v1)
      (coe
...
d__'8746''737'__1078 ::
  ...
  MAlonzo.Code.Agda.Builtin.Sigma.T_Σ_14 ->
  MAlonzo.Code.Agda.Builtin.Sigma.T_Σ_14
d__'8746''737'__1078 v0 ~v1 v2 = du__'8746''737'__1078 v0 v2
du__'8746''737'__1078 ::
  MAlonzo.Code.Axiom.Set.T_Theory_82 ->
  (AgdaAny -> AgdaAny) ->
  () ->
  MAlonzo.Code.Agda.Builtin.Sigma.T_Σ_14 ->
  MAlonzo.Code.Agda.Builtin.Sigma.T_Σ_14 ->
  MAlonzo.Code.Agda.Builtin.Sigma.T_Σ_14
du__'8746''737'__1078 v0 v1 v2 v3 v4
  = coe du__'8746''737'__676 (coe v0) (coe v1) v3 v4
-- Axiom.Set.Map.Restrictionᵐ._._∪ˡ'_
d__'8746''737'''__1080 ::
  MAlonzo.Code.Axiom.Set.T_Theory_82 ->
  () -> (AgdaAny -> AgdaAny) -> () -> AgdaAny -> AgdaAny -> AgdaAny
d__'8746''737'''__1080 v0 ~v1 v2 = du__'8746''737'''__1080 v0 v2
du__'8746''737'''__1080 ::
  MAlonzo.Code.Axiom.Set.T_Theory_82 ->
  (AgdaAny -> AgdaAny) -> () -> AgdaAny -> AgdaAny -> AgdaAny
du__'8746''737'''__1080 v0 v1 v2 v3 v4
  = coe du__'8746''737'''__670 (coe v0) (coe v1) v3 v4
-- Axiom.Set.Map.Restrictionᵐ._.disjoint-∪ˡ-∪
d_disjoint'45''8746''737''45''8746'_1082 ::
  MAlonzo.Code.Axiom.Set.T_Theory_82 ->
  () ->
  (AgdaAny -> AgdaAny) ->
  () ->
  ...
  (AgdaAny ->
   ...
   AgdaAny -> MAlonzo.Code.Data.Irrelevant.T_Irrelevant_20) ->
  MAlonzo.Code.Agda.Builtin.Sigma.T_Σ_14
d_disjoint'45''8746''737''45''8746'_1082 v0 ~v1 v2
  = du_disjoint'45''8746''737''45''8746'_1082 v0 v2
du_disjoint'45''8746''737''45''8746'_1082 ::
  MAlonzo.Code.Axiom.Set.T_Theory_82 ->
  (AgdaAny -> AgdaAny) ->
  () ->
  AgdaAny ->
  ...
  (AgdaAny ->
   ...
   AgdaAny -> MAlonzo.Code.Data.Irrelevant.T_Irrelevant_20) ->
  MAlonzo.Code.Agda.Builtin.Sigma.T_Σ_14
du_disjoint'45''8746''737''45''8746'_1082 v0 v1 v2 v3 v4 v5
  = coe
      du_disjoint'45''8746''737''45''8746'_690 (coe v0) (coe v1) v3 v4 v5
...
d__'8746''737'__1248 ::
  ...
  MAlonzo.Code.Agda.Builtin.Sigma.T_Σ_14 ->
  MAlonzo.Code.Agda.Builtin.Sigma.T_Σ_14
d__'8746''737'__1248 v0 ~v1 v2 = du__'8746''737'__1248 v0 v2
du__'8746''737'__1248 ::
  MAlonzo.Code.Axiom.Set.T_Theory_82 ->
  (AgdaAny -> AgdaAny) ->
  () ->
  MAlonzo.Code.Agda.Builtin.Sigma.T_Σ_14 ->
  MAlonzo.Code.Agda.Builtin.Sigma.T_Σ_14 ->
  MAlonzo.Code.Agda.Builtin.Sigma.T_Σ_14
du__'8746''737'__1248 v0 v1 v2 v3 v4
  = coe du__'8746''737'__676 (coe v0) (coe v1) v3 v4
-- Axiom.Set.Map.Lookupᵐ._._∪ˡ'_
d__'8746''737'''__1250 ::
  MAlonzo.Code.Axiom.Set.T_Theory_82 ->
  () -> (AgdaAny -> AgdaAny) -> () -> AgdaAny -> AgdaAny -> AgdaAny
d__'8746''737'''__1250 v0 ~v1 v2 = du__'8746''737'''__1250 v0 v2
du__'8746''737'''__1250 ::
  MAlonzo.Code.Axiom.Set.T_Theory_82 ->
  (AgdaAny -> AgdaAny) -> () -> AgdaAny -> AgdaAny -> AgdaAny
du__'8746''737'''__1250 v0 v1 v2 v3 v4
  = coe du__'8746''737'''__670 (coe v0) (coe v1) v3 v4
-- Axiom.Set.Map.Lookupᵐ._.disjoint-∪ˡ-∪
d_disjoint'45''8746''737''45''8746'_1252 ::
  MAlonzo.Code.Axiom.Set.T_Theory_82 ->
  () ->
  (AgdaAny -> AgdaAny) ->
  () ->
  ...
  (AgdaAny ->
   ...
   AgdaAny -> MAlonzo.Code.Data.Irrelevant.T_Irrelevant_20) ->
  MAlonzo.Code.Agda.Builtin.Sigma.T_Σ_14
d_disjoint'45''8746''737''45''8746'_1252 v0 ~v1 v2
  = du_disjoint'45''8746''737''45''8746'_1252 v0 v2
du_disjoint'45''8746''737''45''8746'_1252 ::
  MAlonzo.Code.Axiom.Set.T_Theory_82 ->
  (AgdaAny -> AgdaAny) ->
  () ->
  AgdaAny ->
  ...
  (AgdaAny ->
   ...
   AgdaAny -> MAlonzo.Code.Data.Irrelevant.T_Irrelevant_20) ->
  MAlonzo.Code.Agda.Builtin.Sigma.T_Σ_14
du_disjoint'45''8746''737''45''8746'_1252 v0 v1 v2 v3 v4 v5
  = coe
      du_disjoint'45''8746''737''45''8746'_690 (coe v0) (coe v1) v3 v4 v5
...
du__'8638'__1340 v0 v1 v2 v3
  = coe
      ...
      (coe
         (\ v4 ->
            coe
              MAlonzo.Code.Axiom.Set.Rel.du__'8638'__886 (coe v0) (coe v1)
              (coe v4) (coe v3)))
      (coe v2)
...
du__'8638'_'7580'_1348 v0 v1 v2 v3
  = coe
      ...
      (coe
         (\ v4 ->
            coe
              MAlonzo.Code.Axiom.Set.Rel.du__'8638'_'7580'_892 (coe v0) (coe v1)
              (coe v4) (coe v3)))
      (coe v2)
-- Axiom.Set.Map.Corestrictionᵐ._⁻¹_
d__'8315''185'__1356 ::
...
d_'46'generalizedField'45'A_122623 :: T_GeneralizeTel_122631 -> ()
d_'46'generalizedField'45'A_122623 = erased
-- Axiom.Set.Map..generalizedField-B
d_'46'generalizedField'45'B_122625 :: T_GeneralizeTel_122631 -> ()
d_'46'generalizedField'45'B_122625 = erased
-- Axiom.Set.Map..generalizedField-B'
d_'46'generalizedField'45'B''_122627 ::
  T_GeneralizeTel_122631 -> ()
d_'46'generalizedField'45'B''_122627 = erased
-- Axiom.Set.Map..generalizedField-R
d_'46'generalizedField'45'R_122629 ::
  T_GeneralizeTel_122631 -> AgdaAny
d_'46'generalizedField'45'R_122629
  = MAlonzo.RTE.mazUnreachableError
-- Axiom.Set.Map.GeneralizeTel
d_GeneralizeTel_122631 a0 = ()
newtype T_GeneralizeTel_122631 = C_mkGeneralizeTel_122633 AgdaAny
