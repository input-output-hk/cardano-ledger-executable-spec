...
d_Computational'45'ENACT_1470 v0
  = coe
      MAlonzo.Code.Ledger.GovernanceActions.Properties.d_Computational'45'ENACT_714
...
d__'8866'_'8640''10631'_'44'RATIFY'''10632'__1544 a0 a1 a2 a3 a4
  = ()
-- Ledger.Ratify.Properties._._⊢_⇀⦇_,RATIFY⦈_
d__'8866'_'8640''10631'_'44'RATIFY'10632'__1546 ::
  MAlonzo.Code.Ledger.Transaction.T_TransactionStructure_20 ->
  MAlonzo.Code.Ledger.Ratify.T_RatifyEnv_1636 ->
  MAlonzo.Code.Ledger.Ratify.T_RatifyState_1658 ->
  [MAlonzo.Code.Agda.Builtin.Sigma.T_Σ_14] ->
  MAlonzo.Code.Ledger.Ratify.T_RatifyState_1658 -> ()
d__'8866'_'8640''10631'_'44'RATIFY'10632'__1546 = erased
-- Ledger.Ratify.Properties._.RatifyState
d_RatifyState_1564 a0 = ()
...
d_exp'63'_1748 ::
  ...
  MAlonzo.Code.Agda.Builtin.Sigma.T_Σ_14 ->
  MAlonzo.Code.Relation.Nullary.Decidable.Core.T_Dec_20
d_exp'63'_1748 v0 v1 ~v2 v3 = du_exp'63'_1748 v0 v1 v3
du_exp'63'_1748 ::
  MAlonzo.Code.Ledger.Transaction.T_TransactionStructure_20 ->
  MAlonzo.Code.Ledger.Ratify.T_RatifyEnv_1636 ->
  MAlonzo.Code.Agda.Builtin.Sigma.T_Σ_14 ->
  MAlonzo.Code.Relation.Nullary.Decidable.Core.T_Dec_20
du_exp'63'_1748 v0 v1 v2
  = coe
...
d_del'63'_1750 ::
  ...
  MAlonzo.Code.Agda.Builtin.Sigma.T_Σ_14 ->
  MAlonzo.Code.Relation.Nullary.Decidable.Core.T_Dec_20
d_del'63'_1750 v0 ~v1 v2 v3 = du_del'63'_1750 v0 v2 v3
du_del'63'_1750 ::
  MAlonzo.Code.Ledger.Transaction.T_TransactionStructure_20 ->
  MAlonzo.Code.Ledger.Ratify.T_RatifyState_1658 ->
  MAlonzo.Code.Agda.Builtin.Sigma.T_Σ_14 ->
  MAlonzo.Code.Relation.Nullary.Decidable.Core.T_Dec_20
du_del'63'_1750 v0 v1 v2
  = coe
...
d_RATIFY'''45'total_1754 ::
  MAlonzo.Code.Ledger.Transaction.T_TransactionStructure_20 ->
  MAlonzo.Code.Ledger.Ratify.T_RatifyEnv_1636 ->
  MAlonzo.Code.Ledger.Ratify.T_RatifyState_1658 ->
  MAlonzo.Code.Agda.Builtin.Sigma.T_Σ_14 ->
  MAlonzo.Code.Agda.Builtin.Sigma.T_Σ_14
d_RATIFY'''45'total_1754 v0 v1 v2 v3
  = let v4 = d_acc'63'_1746 (coe v0) (coe v1) (coe v2) (coe v3) in
    coe
      (let v5 = coe du_exp'63'_1748 (coe v0) (coe v1) (coe v3) in
       coe
         (let v6 = coe du_del'63'_1750 (coe v0) (coe v2) (coe v3) in
          coe
            (case coe v4 of
                                      ...
                                      -> if coe v10
                                           then case coe v11 of
                                                  ...
                                                  (coe
                                                     ...
                                                     (coe
                                                        d_es''_1744 (coe v0) (coe v1) (coe v2)
                                                        (coe v3))
                                                     (coe
                                                        (\ v12 v13 ->
                                                           coe
                                                             ...
                                                             (coe
                                                                ...
                                                                (coe
                                                                   ...
                                                                   (let v14
                                                                          = coe
                                                                              MAlonzo.Code.Ledger.Ratify.C_mkGeneralizeTel_102813
                                                                              (coe v1) (coe v3)
                                                                              (coe
                                                                    ...
                                                                    coe
                                                                      (coe
                                                                         ...
                                                                         (coe
                                                                            ...
                                                                            (coe
                                                                               MAlonzo.Code.Ledger.Ratify.d_'46'generalizedField'45'a_102801
                                                                               v14))))))
                                                             (coe
                                                                         ...
                                                                         (let v14
                                                                          ...
                                                                          coe
                                                                            (coe
                                                                               ...
                                                                               (coe
                                                                                  MAlonzo.Code.Ledger.Ratify.d_'46'generalizedField'45'Γ_102799
                                                                                  v14)))
                                                                         (let v14
                                                                                = coe
                                                                                    MAlonzo.Code.Ledger.Ratify.C_mkGeneralizeTel_102813
...
d_computeProof_1780 ::
  ...
  MAlonzo.Code.Agda.Builtin.Sigma.T_Σ_14 ->
  MAlonzo.Code.Interface.ComputationalRelation.T_ComputationResult_34
d_computeProof_1780 v0 v1 v2 v3
  = coe
      MAlonzo.Code.Interface.ComputationalRelation.C_success_42
      (coe d_RATIFY'''45'total_1754 (coe v0) (coe v1) (coe v2) (coe v3))
-- Ledger.Ratify.Properties.Implementation.RATIFY'-completeness
d_RATIFY'''45'completeness_1784 ::
  MAlonzo.Code.Ledger.Transaction.T_TransactionStructure_20 ->
  MAlonzo.Code.Ledger.Ratify.T_RatifyEnv_1636 ->
  MAlonzo.Code.Ledger.Ratify.T_RatifyState_1658 ->
  MAlonzo.Code.Agda.Builtin.Sigma.T_Σ_14 ->
...
d_RATIFY'''45'completeness_1784 = erased
...
d_completeness_1886 ::
  ...
  MAlonzo.Code.Ledger.Ratify.T__'8866'_'8640''10631'_'44'RATIFY'''10632'__2206 ->
  MAlonzo.Code.Agda.Builtin.Equality.T__'8801'__12
d_completeness_1886 = erased
-- Ledger.Ratify.Properties.Computational-RATIFY'
d_Computational'45'RATIFY''_1888 ::
  MAlonzo.Code.Ledger.Transaction.T_TransactionStructure_20 ->
  MAlonzo.Code.Interface.ComputationalRelation.T_Computational_232
d_Computational'45'RATIFY''_1888 v0
  = coe
      MAlonzo.Code.Interface.ComputationalRelation.C_MkComputational_412
      (d_computeProof_1780 (coe v0))
-- Ledger.Ratify.Properties.Computational-RATIFY
d_Computational'45'RATIFY_1890 ::
  MAlonzo.Code.Ledger.Transaction.T_TransactionStructure_20 ->
  MAlonzo.Code.Interface.ComputationalRelation.T_Computational_232
d_Computational'45'RATIFY_1890 v0
  = coe
      ...
      (coe d_Computational'45'RATIFY''_1888 (coe v0))
      (coe
...
d_RATIFY'45'total_1900 ::
  MAlonzo.Code.Ledger.Transaction.T_TransactionStructure_20 ->
  MAlonzo.Code.Ledger.Ratify.T_RatifyEnv_1636 ->
  MAlonzo.Code.Ledger.Ratify.T_RatifyState_1658 ->
  [MAlonzo.Code.Agda.Builtin.Sigma.T_Σ_14] ->
  MAlonzo.Code.Agda.Builtin.Sigma.T_Σ_14
d_RATIFY'45'total_1900 v0 v1 v2 v3
  = coe
      MAlonzo.Code.Interface.STS.du_ReflexiveTransitiveClosure'45'total_126
      (coe
         (\ v4 v5 v6 ->
            d_RATIFY'''45'total_1754 (coe v0) (coe v4) (coe v5) (coe v6)))
      (coe v1) (coe v2) (coe v3)
-- Ledger.Ratify.Properties.RATIFY-complete
d_RATIFY'45'complete_1910 ::
  MAlonzo.Code.Ledger.Transaction.T_TransactionStructure_20 ->
  MAlonzo.Code.Ledger.Ratify.T_RatifyEnv_1636 ->
  MAlonzo.Code.Ledger.Ratify.T_RatifyState_1658 ->
  [MAlonzo.Code.Agda.Builtin.Sigma.T_Σ_14] ->
  ...
  MAlonzo.Code.Agda.Builtin.Equality.T__'8801'__12
d_RATIFY'45'complete_1910 = erased
