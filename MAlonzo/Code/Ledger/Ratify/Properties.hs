...
d_Computational'45'ENACT_1554 ::
  MAlonzo.Code.Ledger.Transaction.T_TransactionStructure_20 ->
  MAlonzo.Code.Interface.ComputationalRelation.T_Computational_232
d_Computational'45'ENACT_1554 v0
  = coe
      MAlonzo.Code.Ledger.GovernanceActions.Properties.d_Computational'45'ENACT_798
...
d__'8866'_'8640''10631'_'44'RATIFY'''10632'__1628 a0 a1 a2 a3 a4
  = ()
-- Ledger.Ratify.Properties._._⊢_⇀⦇_,RATIFY⦈_
d__'8866'_'8640''10631'_'44'RATIFY'10632'__1630 ::
  MAlonzo.Code.Ledger.Transaction.T_TransactionStructure_20 ->
  MAlonzo.Code.Ledger.Ratify.T_RatifyEnv_1718 ->
  MAlonzo.Code.Ledger.Ratify.T_RatifyState_1740 ->
  [MAlonzo.Code.Agda.Builtin.Sigma.T_Σ_14] ->
  MAlonzo.Code.Ledger.Ratify.T_RatifyState_1740 -> ()
d__'8866'_'8640''10631'_'44'RATIFY'10632'__1630 = erased
-- Ledger.Ratify.Properties._.RatifyState
d_RatifyState_1648 a0 = ()
...
d_es''_1828 v0 v1 v2 v3
  = coe
      ...
      (coe
         ...
         (coe MAlonzo.Code.Ledger.Transaction.d_govStructure_2110 (coe v0)))
      (coe
         MAlonzo.Code.Ledger.Enact.C_'10214'_'44'_'44'_'10215''7497'_726
         (coe MAlonzo.Code.Agda.Builtin.Sigma.d_fst_28 (coe v3))
         (coe MAlonzo.Code.Ledger.Ratify.d_treasury_1738 (coe v1))
         (coe MAlonzo.Code.Ledger.Ratify.d_currentEpoch_1732 (coe v1)))
      (coe MAlonzo.Code.Ledger.Ratify.d_es_1748 (coe v2))
      (coe
...
d_acc'63'_1830 v0 v1 v2 v3
  = coe
      MAlonzo.Code.Ledger.Ratify.d_accepted'63'_2256 (coe v0) (coe v1)
      (coe MAlonzo.Code.Ledger.Ratify.d_es_1748 (coe v2))
      (coe MAlonzo.Code.Agda.Builtin.Sigma.d_snd_30 (coe v3))
...
du_exp'63'_1832 v0 v1 v2
  = coe
      MAlonzo.Code.Ledger.Ratify.d_expired'63'_2270 (coe v0)
      (coe MAlonzo.Code.Ledger.Ratify.d_currentEpoch_1732 (coe v1))
...
d_del'63'_1834 ::
  ...
  MAlonzo.Code.Agda.Builtin.Sigma.T_Σ_14 ->
  MAlonzo.Code.Relation.Nullary.Decidable.Core.T_Dec_20
d_del'63'_1834 v0 ~v1 v2 v3 = du_del'63'_1834 v0 v2 v3
du_del'63'_1834 ::
  MAlonzo.Code.Ledger.Transaction.T_TransactionStructure_20 ->
  MAlonzo.Code.Ledger.Ratify.T_RatifyState_1740 ->
  MAlonzo.Code.Agda.Builtin.Sigma.T_Σ_14 ->
  MAlonzo.Code.Relation.Nullary.Decidable.Core.T_Dec_20
du_del'63'_1834 v0 v1 v2
  = coe
      MAlonzo.Code.Ledger.Ratify.d_delayed'63'_2218 (coe v0)
      (coe
         MAlonzo.Code.Ledger.GovernanceActions.d_action_694
         (coe MAlonzo.Code.Agda.Builtin.Sigma.d_snd_30 (coe v2)))
      (coe
         ...
         (coe MAlonzo.Code.Agda.Builtin.Sigma.d_snd_30 (coe v2)))
      (coe MAlonzo.Code.Ledger.Ratify.d_es_1748 (coe v1))
      (coe MAlonzo.Code.Ledger.Ratify.d_delay_1752 (coe v1))
...
d_RATIFY'''45'total_1838 v0 v1 v2 v3
  = let v4
          = MAlonzo.Code.Ledger.Ratify.d_accepted'63'_2256
              (coe v0) (coe v1)
              (coe MAlonzo.Code.Ledger.Ratify.d_es_1748 (coe v2))
              (coe MAlonzo.Code.Agda.Builtin.Sigma.d_snd_30 (coe v3)) in
    coe
      (let v5
             = MAlonzo.Code.Ledger.Ratify.d_expired'63'_2270
                 (coe v0)
                 (coe MAlonzo.Code.Ledger.Ratify.d_currentEpoch_1732 (coe v1))
                 (coe MAlonzo.Code.Agda.Builtin.Sigma.d_snd_30 (coe v3)) in
       coe
         (let v6
                = MAlonzo.Code.Ledger.Ratify.d_delayed'63'_2218
                    (coe v0)
                    (coe
                       MAlonzo.Code.Ledger.GovernanceActions.d_action_694
                       (coe MAlonzo.Code.Agda.Builtin.Sigma.d_snd_30 (coe v3)))
                    (coe
                       ...
                       (coe MAlonzo.Code.Agda.Builtin.Sigma.d_snd_30 (coe v3)))
                    (coe MAlonzo.Code.Ledger.Ratify.d_es_1748 (coe v2))
                    (coe MAlonzo.Code.Ledger.Ratify.d_delay_1752 (coe v2)) in
          coe
            (case coe v4 of
                                           ...
                                           then case coe v11 of
                                                  MAlonzo.Code.Relation.Nullary.Reflects.C_of'696'_22 v12
                                                    -> coe
                                                         ...
                                                         (coe v2)
                                                         (coe
                                                            MAlonzo.Code.Ledger.Ratify.C_RATIFY'45'Continue_2362
                                                            (coe
                                                  ...
                                                  (coe
                                                     ...
                                                     (coe
                                                        d_es''_1828 (coe v0) (coe v1) (coe v2)
                                                        (coe v3))
                                                     (coe
                                                        (\ v12 v13 ->
                                                           coe
                                                                 ...
                                                                 coe
                                                                   (coe
                                                                      ...
                                                                      (coe
                                                                         ...
                                                                         (coe v2))))
                                                                (coe
                                                                   MAlonzo.Code.Ledger.Ratify.du_delayingAction_2144
                                                                   (let v14
                                                                          = coe
                                                                              MAlonzo.Code.Ledger.Ratify.C_mkGeneralizeTel_102803
                                                                              (coe v1) (coe v3)
                                                                              (coe
                                                                                 MAlonzo.Code.Ledger.Ratify.d_es_1748
                                                                                 (coe v2))
                                                                              (coe
                                                                                 MAlonzo.Code.Ledger.Ratify.d_delay_1752
                                                                                 (coe v2))
                                                                              (coe v12)
                                                                              (coe
                                                                                 MAlonzo.Code.Ledger.Ratify.d_removed_1750
                                                                    ...
                                                                    coe
                                                                      (coe
                                                                         ...
                                                                         (coe
                                                                            ...
                                                                            (coe
                                                                               MAlonzo.Code.Ledger.Ratify.d_'46'generalizedField'45'a_102791
                                                                               v14))))))
                                                             (coe
                                                                MAlonzo.Code.Ledger.Ratify.C_RATIFY'45'Accept_2316
                                                                v9
                                                                (coe
                                                                   ...
                                                                   (coe
                                                                      ...
                                                                      (coe
                                                                         ...
                                                                         (let v14
                                                                          ...
                                                                          coe
                                                                            (coe
                                                                               MAlonzo.Code.Ledger.Ratify.d_treasury_1738
                                                                               (coe
                                                                                  MAlonzo.Code.Ledger.Ratify.d_'46'generalizedField'45'Γ_102789
                                                                                  v14)))
                                                                         (let v14
                                                                                = coe
                                                                                    MAlonzo.Code.Ledger.Ratify.C_mkGeneralizeTel_102803
                                                                          ...
                                                                          coe
                                                                            (coe
                                                                               MAlonzo.Code.Ledger.Ratify.d_currentEpoch_1732
                                                                               (coe
                                                                                  MAlonzo.Code.Ledger.Ratify.d_'46'generalizedField'45'Γ_102789
                                                                                  v14))))
                                                                      (coe
                                                ...
                                                -> coe
                                                     ...
                                                     (coe
                                                        ...
                                                        (coe
                                                           ...
                                                           (coe v2)))
                                                     (coe
                                                        MAlonzo.Code.Ledger.Ratify.C_RATIFY'45'Reject_2332
                                                        v11)
                                              _ -> MAlonzo.RTE.mazUnreachableError
                                       else coe
                                              seq (coe v10)
...
d_RATIFY'''45'completeness_1868 ::
  ...
  MAlonzo.Code.Agda.Builtin.Sigma.T_Σ_14 ->
  MAlonzo.Code.Ledger.Ratify.T_RatifyState_1740 ->
  MAlonzo.Code.Ledger.Ratify.T__'8866'_'8640''10631'_'44'RATIFY'''10632'__2288 ->
...
d_Computational'45'RATIFY''_1972 ::
  MAlonzo.Code.Ledger.Transaction.T_TransactionStructure_20 ->
  MAlonzo.Code.Interface.ComputationalRelation.T_Computational_232
d_Computational'45'RATIFY''_1972 v0
  = coe
      MAlonzo.Code.Interface.ComputationalRelation.C_MkComputational_412
      (d_computeProof_1864 (coe v0))
-- Ledger.Ratify.Properties.Computational-RATIFY
d_Computational'45'RATIFY_1974 ::
  MAlonzo.Code.Ledger.Transaction.T_TransactionStructure_20 ->
  MAlonzo.Code.Interface.ComputationalRelation.T_Computational_232
d_Computational'45'RATIFY_1974 v0
  = coe
      ...
      (coe d_Computational'45'RATIFY''_1972 (coe v0))
      (coe
...
d_RATIFY'45'total_1984 ::
  MAlonzo.Code.Ledger.Transaction.T_TransactionStructure_20 ->
  MAlonzo.Code.Ledger.Ratify.T_RatifyEnv_1718 ->
  MAlonzo.Code.Ledger.Ratify.T_RatifyState_1740 ->
  [MAlonzo.Code.Agda.Builtin.Sigma.T_Σ_14] ->
  MAlonzo.Code.Agda.Builtin.Sigma.T_Σ_14
d_RATIFY'45'total_1984 v0 v1 v2 v3
  = coe
...
d_RATIFY'45'complete_1994 ::
  ...
  MAlonzo.Code.Agda.Builtin.Equality.T__'8801'__12
d_RATIFY'45'complete_1994 = erased
