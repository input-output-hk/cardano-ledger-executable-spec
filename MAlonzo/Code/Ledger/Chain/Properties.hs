...
d__'8866'_'8640''10631'_'44'CHAIN'10632'__1472 a0 a1 a2 a3 a4 a5
  = ()
-- Ledger.Chain.Properties._._⊢_⇀⦇_,NEWEPOCH⦈_
d__'8866'_'8640''10631'_'44'NEWEPOCH'10632'__1508 a0 a1 a2 a3 a4 a5
  = ()
...
d_Computational'45'CHAIN_1712 ::
  MAlonzo.Code.Ledger.Transaction.T_TransactionStructure_20 ->
  MAlonzo.Code.Ledger.Abstract.T_AbstractFunctions_1480 ->
  MAlonzo.Code.Interface.ComputationalRelation.T_Computational_232
d_Computational'45'CHAIN_1712 v0 v1
  = coe
         ...
         coe
           ...
           (coe
              ...
              (coe
                 ...
                 (coe
                    MAlonzo.Code.Ledger.Epoch.Properties.du_NEWEPOCH'45'total_1850
                    (coe v0)
                    (coe
                       MAlonzo.Code.Ledger.Epoch.C_NewEpochEnv'46'constructor_3811
                       (coe
                          MAlonzo.Code.Ledger.Chain.du_calculateStakeDistrs_2082 (coe v0)
                          (coe
                             MAlonzo.Code.Ledger.Epoch.d_ls_1972
                             (coe
                                MAlonzo.Code.Ledger.Epoch.d_epochState_1994
                                (coe MAlonzo.Code.Ledger.Chain.d_newEpochState_1918 (coe v3))))))
                    (coe MAlonzo.Code.Ledger.Chain.d_newEpochState_1918 (coe v3))
                    (coe
                       MAlonzo.Code.Ledger.Types.Epoch.d_epoch_40
                       (MAlonzo.Code.Ledger.Transaction.d_epochStructure_1354 (coe v0))
                       (MAlonzo.Code.Ledger.Chain.d_slot_1928 (coe v4))))))
           (\ v5 ->
              case coe v5 of
                  ...
                  -> coe
                       ...
                       (coe
                          ...
                          (coe
                             ...
                             (coe
                                MAlonzo.Code.Ledger.Ledger.Properties.d_Computational'45'LEDGER_2354
                                (coe v0) (coe v1))
                             (coe
                             ...
                             (coe
                                ...
                                (coe (\ v8 -> v8))))
                          (coe
                             MAlonzo.Code.Ledger.Ledger.C_'10214'_'44'_'44'_'44'_'10215''737''7497'_1832
                             (coe MAlonzo.Code.Ledger.Chain.d_slot_1928 (coe v4))
                             (coe
                             ...
                             (coe
                                ...
                                (coe
                                   ...
                                   (coe
                                      MAlonzo.Code.Ledger.Epoch.d_es_1974
                                      (coe MAlonzo.Code.Ledger.Epoch.d_epochState_1994 (coe v6)))))
                             (coe
                                MAlonzo.Code.Ledger.Epoch.d_es_1974
                                (coe MAlonzo.Code.Ledger.Epoch.d_epochState_1994 (coe v6))))
                          (MAlonzo.Code.Ledger.Epoch.d_ls_1972
                             (coe MAlonzo.Code.Ledger.Epoch.d_epochState_1994 (coe v6)))
                          (MAlonzo.Code.Ledger.Chain.d_ts_1926 (coe v4)))
                       (\ v8 ->
                          case coe v8 of
                            MAlonzo.Code.Agda.Builtin.Sigma.C__'44'__32 v9 v10
                              -> coe
                                   ...
                                   (coe
                                      ...
                                      (coe
                                         MAlonzo.Code.Ledger.Chain.C_ChainState'46'constructor_3259
                                         (coe
                                            MAlonzo.Code.Ledger.Epoch.C_'10214'_'44'_'10215''8319''7497'_1996
                                            (coe
                                               MAlonzo.Code.Ledger.Epoch.d_lastEpoch_1992 (coe v6))
                                            (coe
                                               ...
                                               (coe
                                                  ...
                                                  (let v11
                                                         = coe
                                                             MAlonzo.Code.Ledger.Chain.C_mkGeneralizeTel_39211
                                                             (coe v3) (coe v4) (coe v6) (coe v9) in
                                                   coe
                                                     (coe
                                                        MAlonzo.Code.Ledger.Epoch.d_epochState_1994
                                                        (coe
                                                           MAlonzo.Code.Ledger.Chain.d_'46'generalizedField'45'nes_39205
                                                           v11))))
                                               (coe v9)
                                               (coe
                                                  MAlonzo.Code.Ledger.Epoch.d_es_1974
                                                   ...
                                                   coe
                                                     (coe
                                                        ...
                                                        (coe
                                                           MAlonzo.Code.Ledger.Chain.d_'46'generalizedField'45'nes_39205
                                                           v11)))))))
                                      (coe MAlonzo.Code.Ledger.Chain.C_CHAIN_2170 v6 v7 v10))
