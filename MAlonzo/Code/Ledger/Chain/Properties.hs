           ...
           (coe
              ...
              (coe
                 ...
                 (coe
                    ...
                    (coe v0)
                    (coe
                       MAlonzo.Code.Ledger.Epoch.C_NewEpochEnv'46'constructor_3709
                       (coe
                          MAlonzo.Code.Ledger.Chain.du_calculateStakeDistrs_1998 (coe v0)
                          (coe
                             MAlonzo.Code.Ledger.Epoch.d_ls_1888
                             (coe
                                MAlonzo.Code.Ledger.Epoch.d_epochState_1910
                                (coe MAlonzo.Code.Ledger.Chain.d_newEpochState_1834 (coe v3))))))
                    (coe MAlonzo.Code.Ledger.Chain.d_newEpochState_1834 (coe v3))
                    (coe
                       MAlonzo.Code.Ledger.Types.Epoch.d_epoch_40
                       (MAlonzo.Code.Ledger.Transaction.d_epochStructure_1270 (coe v0))
                       (MAlonzo.Code.Ledger.Chain.d_slot_1844 (coe v4))))))
           (\ v5 ->
              case coe v5 of
                  ...
                  -> coe
                       ...
                       (coe
                          ...
                          (coe
                             ...
                             (coe
                                MAlonzo.Code.Ledger.Ledger.Properties.d_Computational'45'LEDGER_2270
                                (coe v0) (coe v1))
                             (coe
                             ...
                             (coe
                                ...
                                (coe (\ v8 -> v8))))
                          (coe
                             MAlonzo.Code.Ledger.Ledger.C_'10214'_'44'_'44'_'44'_'10215''737''7497'_1748
                             (coe MAlonzo.Code.Ledger.Chain.d_slot_1844 (coe v4))
                             (coe
                             ...
                             (coe
                                ...
                                (coe
                                   ...
                                   (coe
                                      MAlonzo.Code.Ledger.Epoch.d_es_1890
                                      (coe MAlonzo.Code.Ledger.Epoch.d_epochState_1910 (coe v6)))))
                             (coe
                                MAlonzo.Code.Ledger.Epoch.d_es_1890
                                (coe MAlonzo.Code.Ledger.Epoch.d_epochState_1910 (coe v6))))
                          (MAlonzo.Code.Ledger.Epoch.d_ls_1888
                             (coe MAlonzo.Code.Ledger.Epoch.d_epochState_1910 (coe v6)))
                          (MAlonzo.Code.Ledger.Chain.d_ts_1842 (coe v4)))
                       (\ v8 ->
                          case coe v8 of
                            MAlonzo.Code.Agda.Builtin.Sigma.C__'44'__32 v9 v10
                              -> coe
                                   ...
                                   (coe
                                      ...
                                      (coe
                                         MAlonzo.Code.Ledger.Chain.C_ChainState'46'constructor_3157
                                         (coe
                                            MAlonzo.Code.Ledger.Epoch.C_'10214'_'44'_'10215''8319''7497'_1912
                                            (coe
                                               MAlonzo.Code.Ledger.Epoch.d_lastEpoch_1908 (coe v6))
                                            (coe
                                               ...
                                               (coe
                                                  ...
                                                  (let v11
                                                         = coe
                                                             MAlonzo.Code.Ledger.Chain.C_mkGeneralizeTel_39109
                                                             (coe v3) (coe v4) (coe v6) (coe v9) in
                                                   coe
                                                     (coe
                                                        MAlonzo.Code.Ledger.Epoch.d_epochState_1910
                                                        (coe
                                                           MAlonzo.Code.Ledger.Chain.d_'46'generalizedField'45'nes_39103
                                                           v11))))
                                               (coe v9)
                                               (coe
                                                  MAlonzo.Code.Ledger.Epoch.d_es_1890
                                                   ...
                                                   coe
                                                     (coe
                                                        ...
                                                        (coe
                                                           MAlonzo.Code.Ledger.Chain.d_'46'generalizedField'45'nes_39103
                                                           v11)))))))
                                      (coe MAlonzo.Code.Ledger.Chain.C_CHAIN_2086 v6 v7 v10))
