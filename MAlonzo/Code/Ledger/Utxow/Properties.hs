...
d__'8866'_'8640''10631'_'44'UTXOW'10632'__1470 a0 a1 a2 a3 a4 a5
  = ()
-- Ledger.Utxow.Properties.Computational-UTXOW
d_Computational'45'UTXOW_1736 ::
  MAlonzo.Code.Ledger.Transaction.T_TransactionStructure_20 ->
  MAlonzo.Code.Ledger.Abstract.T_AbstractFunctions_1478 ->
  MAlonzo.Code.Interface.ComputationalRelation.T_Computational_232
d_Computational'45'UTXOW_1736 v0 v1
  = coe
...
d_genErr_1774 v0 ~v1 ~v2 v3 v4 ~v5 = du_genErr_1774 v0 v3 v4
du_genErr_1774 ::
  MAlonzo.Code.Ledger.Transaction.T_TransactionStructure_20 ->
  MAlonzo.Code.Ledger.Utxo.T_UTxOState_1698 ->
  MAlonzo.Code.Ledger.Transaction.T_Tx_2542 ->
  MAlonzo.Code.Agda.Builtin.String.T_String_6
du_genErr_1774 v0 v1 v2
  = let v3
          = coe
                        ...
                        (coe
                           ...
                           (coe
                              ...
                              (MAlonzo.Code.Ledger.Transaction.d_txscripts_2650
                                 (coe v0) (coe v2)
                                 (coe MAlonzo.Code.Ledger.Utxo.d_utxo_1708 (coe v1)))))
                        erased in
              coe
                (case coe v5 of
                                                ...
                                                (coe
                                                   ...
                                                   (coe
                                                      ...
                                                      (coe
                                                         ...
                                                         (coe v2)))))))
                                     (coe
                                        MAlonzo.Code.Ledger.Utxow.du_witsVKeyNeeded_1806 v0
                                        (MAlonzo.Code.Ledger.Utxo.d_utxo_1708 (coe v1))
                                        (MAlonzo.Code.Ledger.Transaction.d_body_2552 (coe v2))))
                                  erased in
                        coe
                          (case coe v7 of
                                                     ...
                                                     (coe
                                                        ...
                                                        (MAlonzo.Code.Ledger.Crypto.d_DecEq'45'ScriptHash_196
                                                           (coe
                                                              ...
                                                              (coe v0))))
                                                     (coe
                                                        MAlonzo.Code.Ledger.Utxow.du_scriptsNeeded_1808
                                                        v0
  ...
  = let v5
          = MAlonzo.Code.Class.Decidable.Core.d_dec_16
              (coe
                 ...
                 (coe
                    MAlonzo.Code.Ledger.Utxow.du_UTXOW'45'inductive'45'premises_1934
           ...
           -> if coe v6
                then case coe v7 of
                                                                   ...
                                                                   -> coe
                                                                        ...
                                                                        (coe
                                                                           ...
                                                                           (coe
                                                                              (\ v21 v22 ->
                                                                                 coe
                                                                                   MAlonzo.Code.Ledger.Utxow.C_UTXOW'45'inductive_1914
                                                                                   (coe
                                                                        ...
                                                                        (coe
                                                                           ...
                                                                           (MAlonzo.Code.Ledger.Utxo.Properties.d_Computational'45'UTXO_2176
                                                                              (coe v0) (coe v1))
                                                                           v2 v3 v4)
                                                                 _ -> MAlonzo.RTE.mazUnreachableError
                                                          _ -> MAlonzo.RTE.mazUnreachableError
                       ...
                       (coe
                          ...
                          (coe du_genErr_1774 (coe v0) (coe v3) (coe v4)))
         _ -> MAlonzo.RTE.mazUnreachableError)
...
d_completeness_1838 ::
  ...
  MAlonzo.Code.Ledger.Transaction.T_Tx_2542 ->
  MAlonzo.Code.Ledger.Utxo.T_UTxOState_1698 ->
  MAlonzo.Code.Ledger.Utxow.T__'8866'_'8640''10631'_'44'UTXOW'10632'__1810 ->
  MAlonzo.Code.Agda.Builtin.Equality.T__'8801'__12
d_completeness_1838 = erased
