...
d__'8866'_'8640''10631'_'44'UTXOW'10632'__1472 a0 a1 a2 a3 a4 a5
  = ()
...
d_Computational'45'UTXOW_1738 v0 v1
  = coe
      ...
      (d_computeProof_1818 (coe v0) (coe v1))
...
d_genErr_1776 v0 ~v1 ~v2 v3 v4 ~v5 = du_genErr_1776 v0 v3 v4
du_genErr_1776 ::
  MAlonzo.Code.Ledger.Transaction.T_TransactionStructure_20 ->
  MAlonzo.Code.Ledger.Utxo.T_UTxOState_1700 ->
  MAlonzo.Code.Ledger.Transaction.T_Tx_2546 ->
  MAlonzo.Code.Agda.Builtin.String.T_String_6
du_genErr_1776 v0 v1 v2
  = let v3
          = coe
                        ...
                        (coe
                           ...
                           (coe
                              ...
                              (MAlonzo.Code.Ledger.Transaction.d_txscripts_2654
                                 (coe v0) (coe v2)
                                 (coe MAlonzo.Code.Ledger.Utxo.d_utxo_1710 (coe v1)))))
                        erased in
              coe
                (case coe v5 of
                                                ...
                                                (coe
                                                   ...
                                                   (coe
                                                      ...
                                                      (coe
                                                         ...
                                                         (coe v2)))))))
                                     (coe
                                        MAlonzo.Code.Ledger.Utxow.du_witsVKeyNeeded_1808 v0
                                        (MAlonzo.Code.Ledger.Utxo.d_utxo_1710 (coe v1))
                                        (MAlonzo.Code.Ledger.Transaction.d_body_2556 (coe v2))))
                                  erased in
                        coe
                          (case coe v7 of
                                                     ...
                                                     (coe
                                                        ...
                                                        (MAlonzo.Code.Ledger.Crypto.d_DecEq'45'ScriptHash_196
                                                           (coe
                                                              ...
                                                              (coe v0))))
                                                     (coe
                                                        MAlonzo.Code.Ledger.Utxow.du_scriptsNeeded_1810
                                                        v0
...
d_computeProof_1818 v0 v1 v2 v3 v4
  = let v5
          = MAlonzo.Code.Class.Decidable.Core.d_dec_16
              (coe
                 MAlonzo.Code.Agda.Builtin.Sigma.d_snd_30
                 (coe
                    MAlonzo.Code.Ledger.Utxow.du_UTXOW'45'inductive'45'premises_1936
           ...
           -> if coe v6
                then case coe v7 of
                                                                   ...
                                                                   -> coe
                                                                        ...
                                                                        (coe
                                                                           ...
                                                                           (coe
                                                                              (\ v21 v22 ->
                                                                                 coe
                                                                                   MAlonzo.Code.Ledger.Utxow.C_UTXOW'45'inductive_1916
                                                                                   (coe
                                                                        ...
                                                                        (coe
                                                                           ...
                                                                           (MAlonzo.Code.Ledger.Utxo.Properties.d_Computational'45'UTXO_2178
                                                                              (coe v0) (coe v1))
                                                                           v2 v3 v4)
                                                                 _ -> MAlonzo.RTE.mazUnreachableError
                                                          _ -> MAlonzo.RTE.mazUnreachableError
                       ...
                       (coe
                          ...
                          (coe du_genErr_1776 (coe v0) (coe v3) (coe v4)))
         _ -> MAlonzo.RTE.mazUnreachableError)
...
d_completeness_1840 ::
  ...
  MAlonzo.Code.Ledger.Transaction.T_Tx_2546 ->
  MAlonzo.Code.Ledger.Utxo.T_UTxOState_1700 ->
  MAlonzo.Code.Ledger.Utxow.T__'8866'_'8640''10631'_'44'UTXOW'10632'__1812 ->
