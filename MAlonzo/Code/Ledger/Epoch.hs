...
d_Slot'691'_26 ::
  T_EpochStructure_4 -> MAlonzo.Code.Algebra.Bundles.T_Semiring_2022
d_Slot'691'_26 v0
  = case coe v0 of
...
d_ℕtoEpoch_216 v0 v1
  = case coe v1 of
      ...
      _ -> let v2 = subInt (coe v1) (coe (1 :: Integer)) in
           coe (coe d_suc'7497'_44 v0 (d_ℕtoEpoch_216 (coe v0) (coe v2)))
...
data T_GlobalConstants_236
  = C_GlobalConstants'46'constructor_5005 MAlonzo.Code.Interface.DecEq.T_DecEq_14
...
d_DecEq'45'Netw_254 v0
  = case coe v0 of
      C_GlobalConstants'46'constructor_5005 v2 v3 v4 v5 v6 v7 -> coe v2
      _ -> MAlonzo.RTE.mazUnreachableError
...
d_SlotsPerEpoch'7580'_256 v0
  = case coe v0 of
      C_GlobalConstants'46'constructor_5005 v2 v3 v4 v5 v6 v7 -> coe v3
      _ -> MAlonzo.RTE.mazUnreachableError
-- Ledger.Epoch.GlobalConstants.NonZero-SlotsPerEpochᶜ
d_NonZero'45'SlotsPerEpoch'7580'_258 ::
  T_GlobalConstants_236 -> MAlonzo.Code.Data.Nat.Base.T_NonZero_104
d_NonZero'45'SlotsPerEpoch'7580'_258 v0
  = case coe v0 of
      C_GlobalConstants'46'constructor_5005 v2 v3 v4 v5 v6 v7 -> coe v4
      _ -> MAlonzo.RTE.mazUnreachableError
...
d_StabilityWindow'7580'_260 v0
  = case coe v0 of
      C_GlobalConstants'46'constructor_5005 v2 v3 v4 v5 v6 v7 -> coe v5
      _ -> MAlonzo.RTE.mazUnreachableError
-- Ledger.Epoch.GlobalConstants.Quorum
d_Quorum_262 :: T_GlobalConstants_236 -> Integer
d_Quorum_262 v0
  = case coe v0 of
      C_GlobalConstants'46'constructor_5005 v2 v3 v4 v5 v6 v7 -> coe v6
      _ -> MAlonzo.RTE.mazUnreachableError
-- Ledger.Epoch.GlobalConstants.NetworkId
d_NetworkId_264 :: T_GlobalConstants_236 -> AgdaAny
d_NetworkId_264 v0
  = case coe v0 of
      C_GlobalConstants'46'constructor_5005 v2 v3 v4 v5 v6 v7 -> coe v7
      _ -> MAlonzo.RTE.mazUnreachableError
