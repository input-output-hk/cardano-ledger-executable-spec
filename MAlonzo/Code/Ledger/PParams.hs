...
d_DecEq'45'PParamGroup_404 ::
  MAlonzo.Code.Ledger.Crypto.T_Crypto_128 ->
  MAlonzo.Code.Ledger.Types.Epoch.T_EpochStructure_6 ->
  MAlonzo.Code.Ledger.Script.T_ScriptStructure_360 ->
  MAlonzo.Code.Class.DecEq.Core.T_DecEq_10
d_DecEq'45'PParamGroup_404 ~v0 ~v1 ~v2
  = du_DecEq'45'PParamGroup_404
du_DecEq'45'PParamGroup_404 ::
  MAlonzo.Code.Class.DecEq.Core.T_DecEq_10
du_DecEq'45'PParamGroup_404
  = coe
...
d_pvCanFollow'63'_410 ~v0 ~v1 ~v2 v3 v4
  = du_pvCanFollow'63'_410 v3 v4
du_pvCanFollow'63'_410 ::
  MAlonzo.Code.Agda.Builtin.Sigma.T_Σ_14 ->
  MAlonzo.Code.Agda.Builtin.Sigma.T_Σ_14 ->
  MAlonzo.Code.Relation.Nullary.Decidable.Core.T_Dec_20
du_pvCanFollow'63'_410 v0 v1
  = case coe v0 of
...
d_PParamsDiff_458 a0 a1 a2 = ()
data T_PParamsDiff_458
  = C_PParamsDiff'46'constructor_525301 (T_PParams_218 ->
                                         AgdaAny -> T_PParams_218)
                                        (AgdaAny -> [T_PParamGroup_142])
                                        (AgdaAny -> MAlonzo.Code.Class.Decidable.Core.T__'8263'_10)
-- Ledger.PParams.PParamsDiff.UpdateT
d_UpdateT_472 :: T_PParamsDiff_458 -> ()
d_UpdateT_472 = erased
-- Ledger.PParams.PParamsDiff.applyUpdate
d_applyUpdate_474 ::
  T_PParamsDiff_458 -> T_PParams_218 -> AgdaAny -> T_PParams_218
d_applyUpdate_474 v0
  = case coe v0 of
      C_PParamsDiff'46'constructor_525301 v2 v3 v4 -> coe v2
      _ -> MAlonzo.RTE.mazUnreachableError
-- Ledger.PParams.PParamsDiff.updateGroups
d_updateGroups_476 ::
  T_PParamsDiff_458 -> AgdaAny -> [T_PParamGroup_142]
d_updateGroups_476 v0
  = case coe v0 of
      C_PParamsDiff'46'constructor_525301 v2 v3 v4 -> coe v3
      _ -> MAlonzo.RTE.mazUnreachableError
...
d_ppWF'63'_482 v0
  = case coe v0 of
      C_PParamsDiff'46'constructor_525301 v2 v3 v4 -> coe v4
      _ -> MAlonzo.RTE.mazUnreachableError
...
d_ppdWellFormed_484 ::
  ...
  MAlonzo.Code.Ledger.Types.Epoch.T_EpochStructure_6 ->
  MAlonzo.Code.Ledger.Script.T_ScriptStructure_360 ->
  T_PParamsDiff_458 -> AgdaAny -> ()
d_ppdWellFormed_484 = erased
-- Ledger.PParams.GovParams
d_GovParams_490 a0 a1 a2 = ()
data T_GovParams_490
  = C_GovParams'46'constructor_526077 T_PParamsDiff_458
                                      MAlonzo.Code.Ledger.Crypto.T_isHashableSet_6
                                      MAlonzo.Code.Class.DecEq.Core.T_DecEq_10
-- Ledger.PParams._.UpdateT
d_UpdateT_496 :: T_PParamsDiff_458 -> ()
d_UpdateT_496 = erased
-- Ledger.PParams._.applyUpdate
d_applyUpdate_498 ::
  T_PParamsDiff_458 -> T_PParams_218 -> AgdaAny -> T_PParams_218
d_applyUpdate_498 v0 = coe d_applyUpdate_474 (coe v0)
-- Ledger.PParams._.ppWF?
d_ppWF'63'_500 ::
  T_PParamsDiff_458 ->
  AgdaAny -> MAlonzo.Code.Class.Decidable.Core.T__'8263'_10
d_ppWF'63'_500 v0 = coe d_ppWF'63'_482 (coe v0)
...
d_ppdWellFormed_502 ::
  ...
  MAlonzo.Code.Ledger.Script.T_ScriptStructure_360 ->
  T_PParamsDiff_458 -> AgdaAny -> ()
d_ppdWellFormed_502 = erased
-- Ledger.PParams._.updateGroups
d_updateGroups_504 ::
  T_PParamsDiff_458 -> AgdaAny -> [T_PParamGroup_142]
d_updateGroups_504 v0 = coe d_updateGroups_476 (coe v0)
-- Ledger.PParams.GovParams.ppUpd
d_ppUpd_520 :: T_GovParams_490 -> T_PParamsDiff_458
d_ppUpd_520 v0
  = case coe v0 of
      C_GovParams'46'constructor_526077 v1 v2 v3 -> coe v1
      _ -> MAlonzo.RTE.mazUnreachableError
-- Ledger.PParams.GovParams._.UpdateT
d_UpdateT_524 :: T_GovParams_490 -> ()
d_UpdateT_524 = erased
-- Ledger.PParams.GovParams._.applyUpdate
d_applyUpdate_526 ::
  T_GovParams_490 -> T_PParams_218 -> AgdaAny -> T_PParams_218
d_applyUpdate_526 v0
  = coe d_applyUpdate_474 (coe d_ppUpd_520 (coe v0))
-- Ledger.PParams.GovParams._.ppWF?
d_ppWF'63'_528 ::
  T_GovParams_490 ->
  AgdaAny -> MAlonzo.Code.Class.Decidable.Core.T__'8263'_10
d_ppWF'63'_528 v0 = coe d_ppWF'63'_482 (coe d_ppUpd_520 (coe v0))
-- Ledger.PParams.GovParams._.ppdWellFormed
d_ppdWellFormed_530 ::
  MAlonzo.Code.Ledger.Crypto.T_Crypto_128 ->
  MAlonzo.Code.Ledger.Types.Epoch.T_EpochStructure_6 ->
  MAlonzo.Code.Ledger.Script.T_ScriptStructure_360 ->
  T_GovParams_490 -> AgdaAny -> ()
d_ppdWellFormed_530 = erased
-- Ledger.PParams.GovParams._.updateGroups
d_updateGroups_532 ::
  T_GovParams_490 -> AgdaAny -> [T_PParamGroup_142]
d_updateGroups_532 v0
  = coe d_updateGroups_476 (coe d_ppUpd_520 (coe v0))
-- Ledger.PParams.GovParams.ppHashingScheme
d_ppHashingScheme_534 ::
  T_GovParams_490 -> MAlonzo.Code.Ledger.Crypto.T_isHashableSet_6
d_ppHashingScheme_534 v0
  = case coe v0 of
      C_GovParams'46'constructor_526077 v1 v2 v3 -> coe v2
      _ -> MAlonzo.RTE.mazUnreachableError
-- Ledger.PParams.GovParams._.DecEq-T
d_DecEq'45'T_538 ::
  T_GovParams_490 -> MAlonzo.Code.Class.DecEq.Core.T_DecEq_10
d_DecEq'45'T_538 v0
  = coe
      MAlonzo.Code.Ledger.Crypto.d_DecEq'45'T_22
      (coe d_ppHashingScheme_534 (coe v0))
-- Ledger.PParams.GovParams._.DecEq-THash
d_DecEq'45'THash_540 ::
  T_GovParams_490 -> MAlonzo.Code.Class.DecEq.Core.T_DecEq_10
d_DecEq'45'THash_540 v0
  = coe
      MAlonzo.Code.Ledger.Crypto.d_DecEq'45'THash_20
      (coe d_ppHashingScheme_534 (coe v0))
-- Ledger.PParams.GovParams._.THash
d_THash_542 :: T_GovParams_490 -> ()
d_THash_542 = erased
-- Ledger.PParams.GovParams._.T-Hashable
d_T'45'Hashable_544 ::
  T_GovParams_490 -> MAlonzo.Code.Interface.Hashable.T_Hashable_8
d_T'45'Hashable_544 v0
  = coe
...
d_DecEq'45'UpdT_546 ::
  T_GovParams_490 -> MAlonzo.Code.Class.DecEq.Core.T_DecEq_10
d_DecEq'45'UpdT_546 v0
  = case coe v0 of
      C_GovParams'46'constructor_526077 v1 v2 v3 -> coe v3
      _ -> MAlonzo.RTE.mazUnreachableError
